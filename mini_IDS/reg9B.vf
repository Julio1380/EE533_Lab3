...
//  /   /         Filename : reg9B.vf
// /___/   /\     Timestamp : 01/31/2026 18:27:18
// \   \  /  \ 
//  \___\/\___\ 
//
//Command: C:\Xilinx\10.1\ISE\bin\nt\unwrapped\sch2verilog.exe -intstyle ise -family spartan3a -w Z:/533_lab3/mini_IDS/reg9B.sch reg9B.vf
//Design Name: reg9B
//Device: spartan3a
//Purpose:
...
module reg9B(ce, 
   ...
   FD8CE_HXILINX_reg9B XLXI_11 (.C(clk), 
                                .CE(ce), 
                                .CLR(clr), 
                                .D(d[71:64]), 
                                .Q(q[71:64]));
